...
dreamproc()
 {
  echo gnome-terminal --geometry=100x18+$xoff+$yoff --zoom=0.8 -e "desyProc.sh $1 $2 $3 $4 $5 ; echo \"Exiting ....\" ; sleep 3"
  gnome-terminal --geometry=100x18+$xoff+$yoff --zoom=0.8 -e "desyProc.sh $1 $2 $3 $4 $5; echo \"Exiting ....\" ; sleep 3" &
  yoff=`expr $yoff + 290`
 }
...
stopdreamdaq()
 {
  ...
  echo paplay $dreameorsound " &
  paplay $dreameorsound " &
 }
