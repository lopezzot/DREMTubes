//$Id: noesone.h,v 1.1.1.1 2006/07/28 08:05:51 vandelli Exp $
static unsigned int * VMEBASE;
#define MAPCAMAC(ptr) { VMEBASE = (unsigned int *)\
                               ((unsigned int)ptr+0x800000);\
...
{
unsigned int bcnaf24 [8] [8] [32] [16] [32] ;
} BCNAF24;

typedef struct cam16
{
unsigned short bcnaf16 [8] [8] [32] [16] [32] [2] ;
} BCNAF16;

volatile short noeso_dummy_var;
...
{
/*                     Cr  Bm  Ca   0   W    F    N    A*/
unsigned int bcnaf24 [16] [2] [2] [2] [2] [32] [32] [16] ;
} BCNAF24;

typedef struct cam16
{
/*                      cr  Bm  Ca   0   W    F    N    A  Si=l */
unsigned short bcnaf16 [16] [2] [2] [2] [2] [32] [32] [16] [2] ;
} BCNAF16;
...
unsigned int bcnaf24 [16] [4] [2] [2] [2] [2] [32] [32] [16] ;
} BCNAF24;

typedef struct cam16
{
/*                      cr   0  Bm  Ca   0   W    F    N    A  Si=l */
unsigned short bcnaf16 [16] [4] [2] [2] [2] [2] [32] [32] [16] [2] ;
} BCNAF16;
