...
void eradius( const double& energy, const string& file, const string& file2 ){
    ...
    ene << std::fixed << std::setprecision(1) << energy;
    std::string newbeamene = ene.str();
    string outfilename = file+"_"+newbeamene+".root";
    ...
    double totC = 0.;
    double totCcut = 0.;
    double center[2] = {10.0,17.4}; //10.0, 17.4
    double maxdist=10.;
    double threshold = 1.;

    auto Sbarh2 = new TH2F("Sbar","Sbar",2000,-100.,100.,2000,-100.,100.);
    auto Cbarh2 = new TH2F("Cbar","Cbar",2000,-100.,100.,2000,-100.,100.);
    auto Slateralh2 = new TH2F("Slateral","Slateral",30,0.,30.,1000,0.,1.0);
    auto Clateralh2 = new TH2F("Clateral","Clateral",30,0.,30.,1000,0.,1.0);
...
void edisplayDesy(){
    ...
    //5 GeV GEANT4 data, 1.1 deg 
    eradius( 5.0, "run7_1.1Desy", "/DREMTubesout_Run0.root");
    //4.2 GeV GEANT4 data
    eradius(4.2, "run7_1.1Desy", "/DREMTubesout_Run1.root");
    //3.0 GeV GEANT4 data
    eradius(3.0, "run7_1.1Desy", "/DREMTubesout_Run2.root");
    //2.2 GeV GEANT4 data
    eradius(2.2, "run7_1.1Desy", "/DREMTubesout_Run3.root");
    //1.0 GeV GEANT4 data
    eradius(1.0, "run7_1.1Desy", "/DREMTubesout_Run4.root");

    //5 GeV GEANT4 data, 1.2 deg
    eradius( 5.0, "run7_1.2Desy", "/DREMTubesout_Run0.root");
    //4.2 GeV GEANT4 data, 1.2 deg
    eradius( 4.2, "run7_1.2Desy", "/DREMTubesout_Run1.root");
    //3.0 GeV GEANT4 data, 1.2 deg
    eradius( 3.0, "run7_1.2Desy", "/DREMTubesout_Run2.root");
    //2.2 GeV GEANT4 data, 1.2 deg
    eradius( 2.2, "run7_1.2Desy", "/DREMTubesout_Run3.root");
    //1.0 GeV GEANT4 data, 1.2 deg
    eradius( 1.0, "run7_1.2Desy", "/DREMTubesout_Run4.root");

    //5 GeV GEANT4 data, 1.0 deg
    eradius( 5.0, "run7_1.0Desy", "/DREMTubesout_Run0.root");
    //4.2 GeV GEANT4 data, 1.0 deg
    eradius( 4.2, "run7_1.0Desy", "/DREMTubesout_Run1.root");
    //3.0 GeV GEANT4 data, 1.0 deg
    eradius( 3.0, "run7_1.0Desy", "/DREMTubesout_Run2.root");
    //2.2 GeV GEANT4 data, 1.0 deg
    eradius( 2.2, "run7_1.0Desy", "/DREMTubesout_Run3.root");
    //1.0 GeV GEANT4 data, 1.0 deg
    eradius( 1.0, "run7_1.0Desy", "/DREMTubesout_Run4.root");
    
    //5 GeV GEANT4 data, 1.6 deg
    eradius( 5.0, "run7_1.6Desy", "/DREMTubesout_Run0.root");
    //4.2 GeV GEANT4 data, 1.6 deg
    eradius( 4.2, "run7_1.6Desy", "/DREMTubesout_Run1.root");
    //3.0 GeV GEANT4 data, 1.6 deg
    eradius( 3.0, "run7_1.6Desy", "/DREMTubesout_Run2.root");
    //2.2 GeV GEANT4 data, 1.6 deg
    eradius( 2.2, "run7_1.6Desy", "/DREMTubesout_Run3.root");
    //1.0 GeV GEANT4 data, 1.6 deg
    eradius( 1.0, "run7_1.6Desy", "/DREMTubesout_Run4.root");
    
    //5 GeV GEANT4 data, 1.6 deg, 1 cm circle
    eradius( 5.0, "run7_1.6Desy_smr", "/DREMTubesout_Run0.root");
    //4.2 GeV GEANT4 data, 1.6 deg
    eradius( 4.2, "run7_1.6Desy_smr", "/DREMTubesout_Run1.root");
    //3.0 GeV GEANT4 data, 1.6 deg
    eradius( 3.0, "run7_1.6Desy_smr", "/DREMTubesout_Run2.root");
    //2.2 GeV GEANT4 data, 1.6 deg
    eradius( 2.2, "run7_1.6Desy_smr", "/DREMTubesout_Run3.root");
    //1.0 GeV GEANT4 data, 1.6 deg
    eradius( 1.0, "run7_1.6Desy_smr", "/DREMTubesout_Run4.root");

    //5 GeV GEANT4 data, 1.2 deg, 1 cm circle
    eradius( 5.0, "run7_1.2Desy_smr", "/DREMTubesout_Run0.root");
    //4.2 GeV GEANT4 data, 1.2 deg
    eradius( 4.2, "run7_1.2Desy_smr", "/DREMTubesout_Run1.root");
    //3.0 GeV GEANT4 data, 1.2 deg
    eradius( 3.0, "run7_1.2Desy_smr", "/DREMTubesout_Run2.root");
    //2.2 GeV GEANT4 data, 1.2 deg
    eradius( 2.2, "run7_1.2Desy_smr", "/DREMTubesout_Run3.root");
    //1.0 GeV GEANT4 data, 1.2 deg
    eradius( 1.0, "run7_1.2Desy_smr", "/DREMTubesout_Run4.root");
    /*
    //5 GeV GEANT4 EMZ data, 1.1 deg 
    eradius( 5.0, "run7_1.1Desy_EMZ", "/DREMTubesout_Run0.root");
    //4.2 GeV GEANT4 EMZ data
    eradius(4.2, "run7_1.1Desy_EMZ", "/DREMTubesout_Run1.root");
    //3.0 GeV GEANT4 EMZ data
    eradius(3.0, "run7_1.1Desy_EMZ", "/DREMTubesout_Run2.root");
    //2.2 GeV GEANT4 EMZ data
    eradius(2.2, "run7_1.1Desy_EMZ", "/DREMTubesout_Run3.root");
    //1.0 GeV GEANT4 EMZ data
    eradius(1.0, "run7_1.1Desy_EMZ", "/DREMTubesout_Run4.root");

    //5 GeV GEANT4 0.1 data, 1.1 deg 
    eradius( 5.0, "run7Desy_1.1_0p1", "/DREMTubesout_Run0.root");
    //4.2 GeV GEANT4 0.1 data
    eradius(4.2, "run7Desy_1.1_0p1", "/DREMTubesout_Run1.root");
    //3.0 GeV GEANT4 0.1 data
    eradius(3.0, "run7Desy_1.1_0p1", "/DREMTubesout_Run2.root");
    //2.2 GeV GEANT4 0.1 data
    eradius(2.2, "run7Desy_1.1_0p1", "/DREMTubesout_Run3.root");
    //1.0 GeV GEANT4 0.1 data
    eradius(1.0, "run7Desy_1.1_0p1", "/DREMTubesout_Run4.root");

    //5 GeV GEANT4 0.001 data, 1.1 deg 
    eradius( 5.0, "run7Desy_1.1_0p001", "/DREMTubesout_Run0.root");
    //4.2 GeV GEANT4 0.001 data
    eradius(4.2, "run7Desy_1.1_0p001", "/DREMTubesout_Run1.root");
    //3.0 GeV GEANT4 0.001 data
    eradius(3.0, "run7Desy_1.1_0p001", "/DREMTubesout_Run2.root");
    //2.2 GeV GEANT4 0.001 data
    eradius(2.2, "run7Desy_1.1_0p001", "/DREMTubesout_Run3.root");
    //1.0 GeV GEANT4 0.001 data
    eradius(1.0, "run7Desy_1.1_0p001", "/DREMTubesout_Run4.root");
    */
    /*
    //Get 1.4 and 1.7 degree TProfile
    auto tbfile1 = new TFile("run7_1.1_30.root","READ");
