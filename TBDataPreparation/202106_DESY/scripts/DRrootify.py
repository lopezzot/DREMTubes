...
class DRrootify:
    ...
    def __init__(self, fname):
        ...
        self.tbtree.Branch("ADCs",self.ADCs,'ADCs[32]/I')
...
#
datapath = "/eos/user/i/ideadr/TB2021_Desy/rawData/"
ntuplepath = "/eos/user/i/ideadr/TB2021_Desy/rawNtuple/"
datafls = [x.split(".bz2")[0] for x in glob.glob(datapath+"desydata*.bz2")]
