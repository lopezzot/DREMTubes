...
SiPMFileDir="/eos/user/i/ideadr/TB2021_Desy/rawNtupleSiPM"
DaqFileDir="/eos/user/i/ideadr/TB2021_Desy/rawNtuple"
MergedFileDir="/eos/user/i/ideadr/TB2021_Desy/mergedNtuple"
SiPMTreeName = "SiPMData"
SiPMMetaDataTreeName = "EventInfo"
DaqTreeName = "DESY2021"
SiPMNewTreeName = "SiPMDESY2021"
EvtOffset = -1000
doNotMerge = False
...
def doRun(runnumber,outfilename):
    inputDaqFileName = DaqFileDir + "/desydata.run" + str(runnumber) + ".root"
...
def main():
    ...
    parser.add_argument('--runNumber',dest='runNumber',default='0', help='Specify run number. The output file name will be merged_desy2021_run[runNumber].root ')
    ...
    if par.newFiles:
        ...
        for runNumber in rn_list:
            outfilename = MergedFileDir + '/merged_desy2021_run' + str(runNumber) + '.root'
    ...
    if par.runNumber != '0':
        ...
        outfilename = 'merged_desy2021_run' + str(par.runNumber) + '.root'
